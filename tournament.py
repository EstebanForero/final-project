...
def make_initial_matches(players, shuffle, seed):
    ...
    if num_byes > 0:
        bye_interval = len(players) // num_byes
        # Insertar None después de cada intervalo
...
def play(
    ...
    # Save to file
    match_filename = f"match_{a_name}vs{b_name}.json"
